  ...
  public static void main (String[] args) {
    ...
    if (inputLength == 3) {
      ...
      currChar1 = userSymbolString.charAt(posn1);
        ...
        for (int posn2 = 0; posn2 < userSymbolString.length(); posn2++) {  // display all possible solutions
        currChar2 = userSymbolString.charAt(posn2); 
  
          for (int posn3 = 0; posn3 < userSymbolString.length(); posn3++) { 
          currChar3 = userSymbolString.charAt(posn3); 
    
            if (currChar1 == currChar2 && currChar2 == currChar3 && currChar3 == currChar1) { // test if a winner
              total++;
              winner++;  // if so, tally winner
              System.out.println (currChar1 + "" + currChar2 + "" + currChar3 + " is a winner!"); // print winning statement
            } else {
              total++;
              System.out.println (currChar1 + "" + currChar2 + "" + currChar3);
            }
          }
        }
      }
        ...
        for (int posn2 = 0; posn2 < userSymbolString.length(); posn2++) {  // display all possible solutions
          ...
          for (int posn3 = 0; posn3 < userSymbolString.length(); posn3++) { 
            ...
            for(int posn4 = 0; posn4 < userSymbolString.length(); posn4++) {
              ...
              if (currChar1 == currChar2 && currChar2 == currChar3 && currChar3 == currChar4 && currChar4 == currChar1) { // test if a winner
                total++;
                winner++;                                                                         // if so, tally winner
                System.out.println (currChar1 + "" + currChar2 + "" + currChar3 + "" + currChar4 + " is a winner!"); // print winning statement
              } else {
                total++;
                System.out.println (currChar1 + "" + currChar2 + "" + currChar3 + "" + currChar4);
              }
            }
          }
        }
